...
<div class="contenedor seccion seccion-inferior">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p>
                        ...
                        materiales y ahorrando mucho dinero.
                    </p>
                </a>
            </div>
        </article>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img src="./build/img/blog2.jpg" alt="Texto Entrada Blog2" loading="lazy">
                </picture>
            </div>
    ...
    <section class="testimoniales">
        ...
        <div class="testimonial">
            <blockquote>
                El personal se comporto de ua exelente forma, muy buena atencion y la casa que me
                ofrecieron cumple con todas mis expectativas.
            </blockquote>
            <p>-Matias Alias kodak-code</p>
        </div>
    </section>
</div>
